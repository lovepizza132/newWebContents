...
<body>
	...
	<tr>
		<td colspan="2">
			...
			<a href="<%=projectName%>/BoardControl?cmd=reply-form&parentId=<%=rec.getArticleId()%>">답변하기</a>
			<a href="<%=projectName%>/BoardControl?cmd=modify-form&id=<%=rec.getArticleId()%>">수정하기</a>
			<a href="<%=projectName%>/BoardControl?cmd=delete-form&id=<%=rec.getArticleId()%>">삭제하기</a> 	
		</td>
	</tr>
	</table>
