...
// 	List <Message> mList =  ListMessageService.getInstance().getMessageList();
 	ListMessageService service = ListMessageService.getInstance(); //ListMessageService 클래스 객체 생성
 	List <Message> mList = service.getMessageList(pNum); // ListMessageService내 getMessageList(); 메서드 호출
 	// 전체 페이지 수
