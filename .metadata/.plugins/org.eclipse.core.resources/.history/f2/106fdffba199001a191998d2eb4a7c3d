...
<BODY>
	...
	<% } else { %>
		...
		<tr>
			<td><%=mList2.get(i).getArticleId()%></td>
			<td>
			 	...
			 	<%} //end of if%>
				 <a href='BoardView.jsp?id=<%=mList2.get(i).getArticleId()%>'>
				 <%=mList2.get(i).getTitle()%>
				 </a>
			 </td>
			<td><%=mList2.get(i).getWriterName()%></td>
			<td><%=mList2.get(i).getPostingDate()%></td>
			<td><%=mList2.get(i).getReadCount()%></td>
		</tr>
		<% } //end for %> 
	<% } // end else %>
		<tr>
