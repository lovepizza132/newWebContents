 ...
 * Generated at: 2020-05-19 10:40:42 UTC
...
public final class BoardInputFormMvc_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String projectName = "/JSP"; 
      ...
      out.write("/BoardControl?cmd=input-page\");\r\n");
      out.write("\t\t// 유효성 검사\r\n");
      out.write("\t\tvar getName= /^[가-힣]{2,5}$/;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 작성자 공백 확인\r\n");
      out.write("\t\tif($('input[name=writerName]').val()==\"\"){\r\n");
      out.write("\t\t\talert(\"작성자를 입력하세요\")\r\n");
      out.write("\t\t\t$('input[name=writerName]').focus();\r\n");
      ...
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t// 이름 한글 유효성 확인\r\n");
      out.write("\t\tif(!getName.test($('input[name=writerName]').val())){\r\n");
      out.write("\t\t\talert(\"2~5글자의 한글로 입력하세요\")\r\n");
      out.write("\t\t\t$('input[name=writerName]').val()==\"\";\r\n");
      out.write("\t\t\t$('input[name=writerName]').focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
